...
class TrainDataset(Dataset):
    def __init__(self, inputs, labels, pmasks, start_pos, weights=None):
        self.inputs = inputs
        self.labels = labels
        self.pmasks = pmasks
...
def main():
    ...
    def prepare_inputs_and_labels_for_text(
        ...
        return noisy_batch, labels_lm, p_mask, start_pos_list, drop_num, final_weights_out
        

    def simple_collate(batch):
        inp, lbl, msk, spos, wgt = zip(*batch)
        res = {
    ...
    dataset_lm = TrainDataset(input_ids, labels, p_mask_lm, start_pos, final_weights)
